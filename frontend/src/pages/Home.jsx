...
// import bgImg from "../assetsbackgroundImg.png";
// import { 
//   Leaf, 
//   Wind, 
//   Flame, 
...
//       viewport={{ once: true }}
//     >
//       <h2 id="benefits-heading" className="text-4xl font-bold text-neutral-900 mb-4">
...
//         const Icon = benefit.icon; // ✅ Correct way to render component dynamically
//         return (
//           <motion.div
//             key={benefit.title}
...
//               <Icon className="w-8 h-8 text-white" aria-hidden="true" /> {/* ✅ Fixed */}
//             </div>
...
//         const Icon = dosha.icon; // ✅ fix icon rendering
//         return (
//           <motion.div
//             key={dosha.name}
